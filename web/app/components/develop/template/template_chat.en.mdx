...
<Row>
  <Col>
    Get complete execution details by external trace ID, including message content and agent thoughts chain.
    ...
    ### Response
    - `type` (string) Application type: chat / agent
    ...
    - `agent_thoughts` (array) Agent thought chain (Agent apps only)
