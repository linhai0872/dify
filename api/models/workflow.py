...
class WorkflowRunDict(TypedDict):
    ...
    external_trace_id: str | None  # [CUSTOM]
...
class WorkflowRun(Base):
    ...
    - custom_external_trace_id (string) `optional` External trace ID [CUSTOM]
    """
    ...
    __table_args__ = (
        ...
        sa.Index("workflow_run_custom_external_trace_id_idx", "tenant_id", "app_id", "custom_external_trace_id"),
    )
    ...
    custom_external_trace_id: Mapped[str | None] = mapped_column(String(128), nullable=True)
    ...
    def to_dict(self) -> WorkflowRunDict:
        return WorkflowRunDict(
            ...
            external_trace_id=self.custom_external_trace_id,  # [CUSTOM]
        )
    ...
    def from_dict(cls, data: dict[str, Any]) -> "WorkflowRun":
        return cls(
            ...
            custom_external_trace_id=data.get("external_trace_id"),  # [CUSTOM]
        )
